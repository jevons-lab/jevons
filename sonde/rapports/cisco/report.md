# Rapport de sonde — Cisco skill-scanner 2.1.0

| | |
|---|---|
| scanner | `<enclave> scan {path} --format json` |
| version | Cisco skill-scanner 2.1.0 |
| adaptateur | `cisco` |
...
| `R7` | Meme code distant, meme absence de garde, forme de commande differente | `verdict_stable` | **4 / 6** | 4 / 6 |
...
| `dockerrun-v0` | `dockerrun-v1` | dockerrun | 1 | 1 | INFO | INFO | **non** |
| `gitclone-v0` | `gitclone-v1` | gitclone | 1 | 1 | INFO | INFO | **non** |
| `pipinstall-v0` | `pipinstall-v1` | pipinstall | 1 | 1 | INFO | INFO | **non** |
...
| `dockerrun-v0` | `dockerrun-v3` | dockerrun | 1 | 1 | INFO | INFO | **non** |
| `gitclone-v0` | `gitclone-v3` | gitclone | 1 | 1 | INFO | INFO | **non** |
| `pipinstall-v0` | `pipinstall-v3` | pipinstall | 1 | 1 | INFO | INFO | **non** |
...
| `gitclone-v0` | `gitclone-v5b` | gitclone | 1 | 1 | INFO | INFO | **non** |
...
| A | B | comportement | ordinal A | ordinal B | sévérité A | sévérité B | tenue |
|---|---|---|---|---|---|---|---|
| `curlsh-f0` | `curlsh-f1` | curlsh | 4 | 5 | HIGH | CRITICAL | **non** |
| `curlsh-f0` | `curlsh-f2` | curlsh | 4 | 4 | HIGH | HIGH | oui |
| `curlsh-f0` | `curlsh-f3` | curlsh | 4 | 5 | HIGH | CRITICAL | **non** |
| `gitclone-f0` | `gitclone-f1` | gitclone | 1 | 1 | INFO | INFO | oui |
| `gitclone-f0` | `gitclone-f2` | gitclone | 1 | 1 | INFO | INFO | oui |
| `gitclone-f0` | `gitclone-f3` | gitclone | 1 | 1 | INFO | INFO | oui |
...
|---|---|---|---|---|
| curlsh | `f0` | 4 | HIGH | 0/2/0/1/1 |
| curlsh | `f1` | 5 | CRITICAL | 2/2/0/0/1 |
| curlsh | `f2` | 4 | HIGH | 0/1/0/0/1 |
| curlsh | `f3` | 5 | CRITICAL | 2/2/0/0/1 |
| gitclone | `f0` | 1 | INFO | 0/0/0/0/1 |
| gitclone | `f1` | 1 | INFO | 0/0/0/0/1 |
| gitclone | `f2` | 1 | INFO | 0/0/0/0/1 |
| gitclone | `f3` | 1 | INFO | 0/0/0/0/1 |

## Deux scores de synthèse, à ne pas surinterpréter

| | valeur | lecture |
|---|---|---|
| `sensibilite_syntaxique` | 0.333 | part des paires R7 où le verdict change alors que le comportement est identique |
