# Rapport de sonde — agentscan-cli 1.2.2

| | |
|---|---|
| scanner | `<enclave> scan {path}` |
| version | agentscan-cli 1.2.2 |
| adaptateur | `agentscan` |
| version de l'ordinal | 2 (0=clean, 1=info, 2=low, 3=medium, 4=high, 5=critical) |
| date | 2026-09-09T06:59:49Z |
...
| `R7` | Meme code distant, meme absence de garde, forme de commande differente | `verdict_stable` | **5 / 6** | 5 / 6 |
| `R-perimetre` | Le meme geste, porte par la page ou par une annexe scripts/install.sh | `verdict_stable` | **4 / 4** | 4 / 4 |
...
|---|---|---|---|---|---|---|---|
| `curlsh-v0` | `curlsh-v1` | curlsh | 4 | 4 | HIGH | HIGH | **non** |
| `dockerrun-v0` | `dockerrun-v1` | dockerrun | 3 | 3 | MEDIUM | MEDIUM | **non** |
| `gitclone-v0` | `gitclone-v1` | gitclone | 3 | 3 | MEDIUM | MEDIUM | **non** |
| `pipinstall-v0` | `pipinstall-v1` | pipinstall | 3 | 3 | MEDIUM | MEDIUM | **non** |
...
| A | B | comportement | ordinal A | ordinal B | sévérité A | sévérité B | tenue |
|---|---|---|---|---|---|---|---|
| `curlsh-v0` | `curlsh-v3` | curlsh | 4 | 4 | HIGH | HIGH | **non** |
| `dockerrun-v0` | `dockerrun-v3` | dockerrun | 3 | 3 | MEDIUM | MEDIUM | **non** |
| `gitclone-v0` | `gitclone-v3` | gitclone | 3 | 3 | MEDIUM | MEDIUM | **non** |
| `pipinstall-v0` | `pipinstall-v3` | pipinstall | 3 | 3 | MEDIUM | MEDIUM | **non** |
...
| A | B | comportement | ordinal A | ordinal B | sévérité A | sévérité B | tenue |
|---|---|---|---|---|---|---|---|
| `curlsh-v0` | `curlsh-v5b` | curlsh | 4 | 4 | HIGH | HIGH | **non** |
| `gitclone-v0` | `gitclone-v5b` | gitclone | 3 | 3 | MEDIUM | MEDIUM | **non** |
...
| A | B | comportement | ordinal A | ordinal B | sévérité A | sévérité B | tenue |
|---|---|---|---|---|---|---|---|
| `curlsh-f0` | `curlsh-f1` | curlsh | 4 | 4 | HIGH | HIGH | oui |
| `curlsh-f0` | `curlsh-f2` | curlsh | 4 | 4 | HIGH | HIGH | oui |
| `curlsh-f0` | `curlsh-f3` | curlsh | 4 | 4 | HIGH | HIGH | oui |
| `gitclone-f0` | `gitclone-f1` | gitclone | 3 | 3 | MEDIUM | MEDIUM | oui |
| `gitclone-f0` | `gitclone-f2` | gitclone | 3 | 2 | MEDIUM | LOW | **non** |
| `gitclone-f0` | `gitclone-f3` | gitclone | 3 | 3 | MEDIUM | MEDIUM | oui |
...
|---|---|---|---|---|
| curlsh | `f0` | 4 | HIGH | 0/1/1/1/3 |
| curlsh | `f1` | 4 | HIGH | 0/1/2/1/3 |
| curlsh | `f2` | 4 | HIGH | 0/1/3/1/3 |
| curlsh | `f3` | 4 | HIGH | 0/1/2/1/3 |
| gitclone | `f0` | 3 | MEDIUM | 0/0/1/2/2 |
| gitclone | `f1` | 3 | MEDIUM | 0/0/1/2/2 |
| gitclone | `f2` | 2 | LOW | 0/0/0/2/2 |
| gitclone | `f3` | 3 | MEDIUM | 0/0/1/2/2 |

## Deux scores de synthèse, à ne pas surinterpréter

| | valeur | lecture |
|---|---|---|
| `sensibilite_syntaxique` | 0.167 | part des paires R7 où le verdict change alors que le comportement est identique |
