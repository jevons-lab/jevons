# Rapport de sonde — ai-skill-scanner, commit 665598f2 (2026-03-01), mode --static

| | |
|---|---|
| scanner | `cd <enclave> && <enclave> -m scanner {path} --static --quiet -o json` |
| version | ai-skill-scanner, commit 665598f2 (2026-03-01), mode --static |
| adaptateur | `generic` |
...
| `R7` | Meme code distant, meme absence de garde, forme de commande differente | `verdict_stable` | **6 / 6** | 6 / 6 |
...
|---|---|---|---|---|---|---|---|
| `curlsh-v0` | `curlsh-v1` | curlsh | 5 | 5 | critical | critical | **non** |
| `dockerrun-v0` | `dockerrun-v1` | dockerrun | 5 | 5 | critical | critical | **non** |
| `gitclone-v0` | `gitclone-v1` | gitclone | 5 | 5 | critical | critical | **non** |
| `pipinstall-v0` | `pipinstall-v1` | pipinstall | 5 | 5 | critical | critical | **non** |
...
| A | B | comportement | ordinal A | ordinal B | sévérité A | sévérité B | tenue |
|---|---|---|---|---|---|---|---|
| `curlsh-v0` | `curlsh-v3` | curlsh | 5 | 5 | critical | critical | **non** |
| `dockerrun-v0` | `dockerrun-v3` | dockerrun | 5 | 5 | critical | critical | **non** |
| `gitclone-v0` | `gitclone-v3` | gitclone | 5 | 5 | critical | critical | **non** |
| `pipinstall-v0` | `pipinstall-v3` | pipinstall | 5 | 5 | critical | critical | **non** |
...
| A | B | comportement | ordinal A | ordinal B | sévérité A | sévérité B | tenue |
|---|---|---|---|---|---|---|---|
| `curlsh-v0` | `curlsh-v5b` | curlsh | 5 | 5 | critical | critical | **non** |
| `gitclone-v0` | `gitclone-v5b` | gitclone | 5 | 5 | critical | critical | **non** |
...
|---|---|---|---|---|
| curlsh | `f0` | 5 | critical | 2/0/2/0/0 |
| curlsh | `f1` | 5 | critical | 1/0/1/2/0 |
| curlsh | `f2` | 5 | critical | 2/0/1/0/0 |
| curlsh | `f3` | 5 | critical | 2/0/2/3/0 |
| gitclone | `f0` | 5 | critical | 1/0/2/1/0 |
| gitclone | `f1` | 5 | critical | 1/0/1/2/0 |
| gitclone | `f2` | 5 | critical | 2/0/1/2/0 |
| gitclone | `f3` | 5 | critical | 1/0/2/3/0 |

## Deux scores de synthèse, à ne pas surinterpréter

| | valeur | lecture |
|---|---|---|
| `sensibilite_syntaxique` | 0.0 | part des paires R7 où le verdict change alors que le comportement est identique |
