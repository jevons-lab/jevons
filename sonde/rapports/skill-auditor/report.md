# Rapport de sonde — claude-skill-auditor 1.0.0

| | |
|---|---|
| scanner | `<enclave> audit {path}/SKILL.md -f json` |
| version | claude-skill-auditor 1.0.0 |
| adaptateur | `generic` |
| version de l'ordinal | 2 (0=clean, 1=info, 2=low, 3=medium, 4=high, 5=critical) |
| date | 2026-09-09T07:02:46Z |
| périmètre | page |
...
| `dockerrun-v0` | `dockerrun-v1` | dockerrun | 0 | 0 | none | none | **non** |
| `gitclone-v0` | `gitclone-v1` | gitclone | 0 | 0 | none | none | **non** |
| `pipinstall-v0` | `pipinstall-v1` | pipinstall | 0 | 0 | none | none | **non** |
...
| `dockerrun-v0` | `dockerrun-v3` | dockerrun | 0 | 0 | none | none | **non** |
| `gitclone-v0` | `gitclone-v3` | gitclone | 0 | 0 | none | none | **non** |
| `pipinstall-v0` | `pipinstall-v3` | pipinstall | 0 | 0 | none | none | **non** |
...
| `gitclone-v0` | `gitclone-v5b` | gitclone | 0 | 0 | none | none | **non** |
...
| A | B | comportement | ordinal A | ordinal B | sévérité A | sévérité B | tenue |
|---|---|---|---|---|---|---|---|
| `curlsh-f0` | `curlsh-f1` | curlsh | 4 | 0 | high | none | **non** |
| `curlsh-f0` | `curlsh-f2` | curlsh | 4 | 0 | high | none | **non** |
| `curlsh-f0` | `curlsh-f3` | curlsh | 4 | 0 | high | none | **non** |
| `gitclone-f0` | `gitclone-f1` | gitclone | 0 | 0 | none | none | oui |
| `gitclone-f0` | `gitclone-f2` | gitclone | 0 | 0 | none | none | oui |
| `gitclone-f0` | `gitclone-f3` | gitclone | 0 | 0 | none | none | oui |
...
| A | B | comportement | ordinal A | ordinal B | sévérité A | sévérité B | tenue |
|---|---|---|---|---|---|---|---|
| `curlsh-v0` | `curlsh-v0-annexe` | curlsh | 4 | 0 | high | none | **non** |
| `dockerrun-v0` | `dockerrun-v0-annexe` | dockerrun | 0 | 0 | none | none | oui |
| `gitclone-v0` | `gitclone-v0-annexe` | gitclone | 0 | 0 | none | none | oui |
| `pipinstall-v0` | `pipinstall-v0-annexe` | pipinstall | 0 | 0 | none | none | oui |
...
|---|---|---|---|---|
| curlsh | `f0` | 4 | high | 0/1/0/0/0 |
| curlsh | `f1` | 0 | none | 0/0/0/0/0 |
| curlsh | `f2` | 0 | none | 0/0/0/0/0 |
| curlsh | `f3` | 0 | none | 0/0/0/0/0 |
| gitclone | `f0` | 0 | none | 0/0/0/0/0 |
| gitclone | `f1` | 0 | none | 0/0/0/0/0 |
| gitclone | `f2` | 0 | none | 0/0/0/0/0 |
| gitclone | `f3` | 0 | none | 0/0/0/0/0 |
...
- Périmètre : page. Un geste déplacé dans une annexe n'est pas vu de la même
