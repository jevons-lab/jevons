# Rapport de sonde — SkillSpector 2.11.0

| | |
|---|---|
| scanner | `<enclave> scan {path} --no-llm --format json` |
| version | SkillSpector 2.11.0 |
| adaptateur | `skillspector` |
...
| curlsh | `f2` | 0 | NONE | 0 |
| curlsh | `f3` | 4 | HIGH | 22 |
| gitclone | `f0` | 0 | NONE | 0 |
| gitclone | `f1` | 0 | NONE | 0 |
| gitclone | `f2` | 0 | NONE | 0 |
| gitclone | `f3` | 0 | NONE | 0 |
